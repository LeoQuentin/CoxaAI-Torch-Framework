...
log_dir = os.path.join(
    project_root, "src/experiments/initial_model_comparison/binary/lightAugReg/logs"
)  # noqa
checkpoint = os.path.join(
    project_root,
    "src/experiments/initial_model_comparison/binary/lightAugReg/modelcheckpoints",
)  # noqa
...
if __name__ == "__main__":
    ...
    for models in ["efficientnet-b7"]:
        ...
        model_checkpoint = ModelCheckpoint(
            dirpath=checkpoint,
            filename=f"{model_id}_{log_checkpoint_suffix}_best_checkpoint"
